    ...
    <>
      <div className="page-head">
        <div className="grow">
          <h1>Profile</h1>
          <p className="muted">
            Your account and leave entitlement history.
          </p>
        </div>
      </div>
      ...
      <div className="grid-2">
        <div className="stack">
          <Card>
            ...
            <div className="card-body">
              ...
              <p className="tiny mt-16">
                Birthday, role, and leave entitlement are managed by an
                administrator.
              </p>
            </div>
          </Card>
          ...
          <Card>
            <CardHead
              title="Entitlement by year"
              sub="Leave is allocated per calendar year."
            />
